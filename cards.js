...
// 티어3는 총액 7~10, 1~4색으로 모양을 다양하게 둔다.
...
// 단색 카드만 총액 6인 것은 이 때문이다. 7로 올리면 살 수가 없다.
const TIER3_PATTERNS = [
  { points: 3, cost: { 1: 2, 2: 2, 3: 2, 4: 2 } }, //  8, 4색 - 넓고 무난한 주력
  { points: 3, cost: { 2: 4, 3: 3 } },             //  7, 2색 - 싸고 빠른 한 방
  { points: 4, cost: { 1: 3, 2: 4, 3: 2 } },       //  9, 3색
  { points: 4, cost: { 1: 4, 2: 4 } },             //  8, 2색
  { points: 4, cost: { 2: 6 } },                   //  6, 1색 - 한 색에 몰아준 보상
  { points: 5, cost: { 1: 3, 2: 4, 3: 3 } },       // 10, 3색 - 최고점
];
